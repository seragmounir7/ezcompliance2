...
RateAndCouponComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: RateAndCouponComponent, selectors: [["app-rate-and-coupon"]], decls: 7, vars: 0, consts: [[1, "container"], ["formGroup", "rateAndCoupon", 1, "row"], [1, "col"], [1, "fas", "fa-pencil-alt", "mr-2"]], template: function RateAndCouponComponent_Template(rf, ctx) { if (rf & 1) {
...
class SubscriptionService {
    ...
    getPlan() {
        return this.https.get(this.apiUrl + 'plan/add').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])((res) => {
