      ...
      var RateAndCouponComponent = /*#__PURE__*/function () {
        ...
        _createClass(RateAndCouponComponent, [{
          ...
          value: function getContact() {
            ...
            this.subscript.getPlan(this.myId).subscribe(function (data) {
          ...
          key: "editPlanInfo",
          value: function editPlanInfo(id) {
            var _this2 = this;

            console.log('id=>', id);
            this.myId = this.dataPlan._id;
            console.log('form', this.rateAndCoupon.value); // this.isEdit = true;

            this.subscript.editPlan(this.myId, this.rateAndCoupon.value).subscribe(function (res) {
              console.log('Data Set response' + res);
              _this2.data = res.data;
              console.log('new response' + _this2.data); // this.dialogRef.close('true');
            });
          }
        }]);
