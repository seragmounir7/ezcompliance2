						...
						if ('1' !== e.getAttribute('data-kt-initialized')) {
							...
							e.hasAttribute('data-bs-delay-hide') &&
								...
								e.hasAttribute('data-bs-delay-show') &&
									(n.show = e.getAttribute(
										'data-bs-delay-show'
									)),
								n && (t.delay = n),
								e.hasAttribute('data-bs-dismiss') &&
									'click' ==
										e.getAttribute('data-bs-dismiss') &&
									(t.dismiss = 'click');
...
var KTThemeMode = (function () {
	var e,
		...
		i = function (e) {
			return (
				'kt_' +
				(document.body.hasAttribute('data-kt-name')
					? document.body.getAttribute('data-kt-name') + '_'
					: '') +
				'theme_mode_' +
				e
		...
		o = function (n, r) {
			if ('light' === n || 'dark' === n) {
				...
				var u = e
					? e.querySelector(
							'[data-kt-element="mode"][data-kt-value="' +
								r +
								'"]'
					  )
					: null;
