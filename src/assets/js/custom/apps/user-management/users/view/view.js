		...
		document
			...
			.addEventListener('click', (t) => {
				t.preventDefault(),
					Swal.fire({
						text:
							'Are you sure you would like sign out all sessions?',
						icon: 'warning',
						showCancelButton: !0,
						buttonsStyling: !1,
			...
			document
				...
				.forEach((t) => {
					t.addEventListener('click', (n) => {
						n.preventDefault();
						const e = t.closest('tr').querySelectorAll('td')[1]
							.innerText;
						Swal.fire({
							text:
			...
			document
				...
				.addEventListener('click', (t) => {
					t.preventDefault(),
						Swal.fire({
							text:
								'Are you sure you would like remove this two-step authentication?',
							icon: 'warning',
							showCancelButton: !0,
							buttonsStyling: !1,
							...
							t.value
								? Swal.fire({
										text:
											'You have removed this two-step authentication!.',
										icon: 'success',
										buttonsStyling: !1,
										confirmButtonText: 'Ok, got it!',
										customClass: {
								...
								: 'cancel' === t.dismiss &&
								  Swal.fire({
										text:
											'Your two-step authentication is still valid!.',
										icon: 'error',
										buttonsStyling: !1,
										confirmButtonText: 'Ok, got it!',
										customClass: {
