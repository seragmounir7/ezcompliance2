					...
					Swal.fire({
						...
						n.value
							...
							: 'cancel' === n.dismiss &&
							  Swal.fire({
									text:
										'Selected  files or folders was not deleted.',
									icon: 'error',
									buttonsStyling: !1,
									confirmButtonText: 'Ok, got it!',
									customClass: {
				...
				(() => {
					...
					r.on('addedfile', function (o) {
						(o.previewElement.querySelector(
							...
							const e = o.previewElement.querySelector(
								'.progress-bar'
							);
							e.style.opacity = '1';
							var t = 1,
						...
						t
							...
							.addEventListener('click', function () {
								r.files.forEach((e) => {
									const t = e.previewElement.querySelector(
										'.progress-bar'
									);
									t.style.opacity = '1';
									var o = 1,
						...
						t
							...
							.addEventListener('click', function () {
								Swal.fire({
									text:
										'Are you sure you would like to remove all files?',
									icon: 'warning',
									showCancelButton: !0,
									buttonsStyling: !1,
