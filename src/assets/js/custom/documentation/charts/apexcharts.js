...
var KTGeneralApexCharts = {
	init: function () {
		...
		(e = document.getElementById('kt_apexcharts_1')),
			...
			(i = KTUtil.getCssVariableValue('--kt-gray-200')),
			(s = KTUtil.getCssVariableValue('--kt-primary')),
			...
			(function () {
				var e = document.getElementById('kt_apexcharts_3'),
					...
					a = KTUtil.getCssVariableValue('--kt-gray-500'),
					i = KTUtil.getCssVariableValue('--kt-gray-200'),
					s = KTUtil.getCssVariableValue('--kt-info'),
					o = KTUtil.getCssVariableValue('--kt-info-light');
				e &&
					new ApexCharts(e, {
						series: [
							{
			...
			(function () {
				var e = document.getElementById('kt_apexcharts_4'),
					...
					o = KTUtil.getCssVariableValue('--kt-success-light'),
					r = KTUtil.getCssVariableValue('--kt-warning'),
					l = KTUtil.getCssVariableValue('--kt-warning-light');
				e &&
					new ApexCharts(e, {
						series: [
							{
			...
			(function () {
				var e = document.getElementById('kt_apexcharts_5'),
					...
					i = KTUtil.getCssVariableValue('--kt-gray-200'),
					s = KTUtil.getCssVariableValue('--kt-primary'),
					o = KTUtil.getCssVariableValue('--kt-primary-light'),
			...
			(function () {
				var e = document.getElementById('kt_apexcharts_6'),
					t = parseInt(KTUtil.css(e, 'height')),
					a = KTUtil.getCssVariableValue('--kt-primary'),
