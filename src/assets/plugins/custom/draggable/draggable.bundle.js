	...
	return (function (e) {
		...
		function (e, t, r) {
			...
			function c(
				e,
				t,
				{ duration: r, easingFunction: n, horizontal: o }
			) {
			...
			class g extends i.default {
				...
				[d]({ overContainer: e, over: t }) {
					requestAnimationFrame(() => {
						...
						this.mirror.parentNode !== e &&
							e.appendChild(this.mirror);
						const r =
							t ||
			...
			class d extends s.default {
				...
				[c](e) {
					return () => {
						...
						this.currentlyCollidingElement = (0, i.closest)(
							e,
							(e) => t.includes(e)
						);
					};
		...
		function (e, t, r) {
			...
			class g extends i.default {
				...
				getSortableElementsForContainer(e) {
					return [
						...e.querySelectorAll(this.options.draggable)
					].filter(
						(t) =>
		...
		function (e, t, r) {
			...
			class y {
				constructor(e = [document.body], t = {}) {
					...
					const s = new c.DraggableInitializedEvent({
						draggable: this
					});
					this.on(
						'mirror:created',
						({ mirror: e }) => (this.mirror = e)
					),
				...
				destroy() {
					...
					this.trigger(e),
						this.removePlugin(
							...this.plugins.map((e) => e.constructor)
						),
						this.removeSensor(
							...this.sensors.map((e) => e.constructor)
						);
				}
				addPlugin(...e) {
				...
				addSensor(...e) {
					const t = e.map(
						(e) => new e(this.containers, this.options)
					);
					return (
						t.forEach((e) => e.attach()),
				...
				getDraggableElements() {
					return this.containers.reduce(
						(e, t) => [
							...e,
							...this.getDraggableElementsForContainer(t)
						],
						[]
					);
				}
		...
		function (e, t, r) {
			...
			class p extends i.default {
				...
				[l](e) {
					...
					t &&
						((t.draggable = !1), (this.nativeDraggableElement = t)),
			...
			Object.defineProperty(t, '__esModule', { value: !0 }),
				(t.default = function (e, t) {
					...
					do {
						if (
							((d =
								d.correspondingUseElement ||
								d.correspondingElement ||
								d),
							(h = d)
								? a
									? n.call(h, r)
			...
			class g extends i.default {
				...
				getScrollableElement(e) {
					return this.hasDefinedScrollableElements()
						...
						: (function (e) {
								if (!e) return f();
								const t = getComputedStyle(e).getPropertyValue(
										'position'
									),
									r = 'absolute' === t,
									n = (0, a.closest)(
				...
				hasDefinedScrollableElements() {
					return Boolean(
						0 !== this.options.scrollableElements.length
					);
				}
				[l](e) {
			...
			class i extends s.default {
				...
				get originalEvent() {
					return this.sensorEvent
						? this.sensorEvent.originalEvent
						: null;
				}
			}
			t.MirrorEvent = i;
		...
		function (e, t, r) {
			...
			const u = (t.onDragStart = Symbol('onDragStart')),
				...
				p = (t.getAppendableContainer = Symbol(
			...
			function y(e) {
				...
				return M((e) => {
					const i =
							null === n.cursorOffsetY
								? t.clientY - r.top
								: n.cursorOffsetY,
						a =
							null === n.cursorOffsetX
								? t.clientX - r.left
								: n.cursorOffsetX;
					e(
						o(
			...
			function O(e) {
				...
				return M((e) => {
					t.classList.add(...r),
						e(o({ mirror: t, mirrorClasses: r }, n));
				});
			}
			function S(e) {
				let { mirror: t } = e,
		...
		function (e, t, r) {
			...
			class a extends i {}
			(t.DraggableInitializedEvent = a),
				(a.type = 'draggable:initialize');
			class l extends i {}
	...
	(function (e, t) {
		...
		return (function (e) {
			...
			function (e, t, r) {
				...
				class y {
					...
					destroy() {
						...
						const e = new c.DraggableDestroyEvent({
							draggable: this
						});
						this.trigger(e),
							this.removePlugin(
					...
					getDraggableElementsForContainer(e) {
						return [
							...
							(e) =>
								e !== this.originalSource && e !== this.mirror
						);
					}
					[h](e) {
						const t = E(e),
					...
					[c]() {
						cancelAnimationFrame(this.scrollAnimationFrame),
							cancelAnimationFrame(
								this.findScrollableElementFrame
							),
							(this.scrollableElement = null),
							(this.scrollAnimationFrame = null),
							(this.findScrollableElementFrame = null),
				...
				class m extends i.default {
					...
					[c](e) {
						...
						if (
							...
							const { x: e, y: t } = this.lastMirrorMovedClient;
							if (
								(Math.abs(e - o.clientX) <
								this.options.thresholdX
									? (s = !1)
									: (this.lastMirrorMovedClient.x =
											o.clientX),
								Math.abs(t - o.clientY) <
								this.options.thresholdY
									? (i = !1)
			...
			function (e, t, r) {
				...
				(t.DragOverContainerEvent = d),
					(d.type = 'drag:over:container');
				class h extends i {
					get overContainer() {
						return this.data.overContainer;
					}
			...
			function (e, t, r) {
				...
				class p extends i.default {
					...
					[l](e) {
						if (
							e.target &&
							(e.target.form || e.target.contenteditable)
						)
							return;
						const t = (0, o.closest)(e.target, (e) => e.draggable);
						t &&
							((t.draggable = !1),
							(this.nativeDraggableElement = t)),
							document.addEventListener('mouseup', this[u], !0),
							document.addEventListener('dragstart', this[c], !1),
							document.addEventListener('dragover', this[d], !1),
							document.addEventListener('dragend', this[h], !1),
			...
			function (e, t, r) {
				...
				var n,
					...
					X = function (e) {
						var t;
						return (
							!(!h(e) || 'function' != typeof (t = e.then)) && t
						);
					},
					F = function (e, t) {
						if (!e._n) {
			...
			function (e, t, r) {
				for (
					...
					if (
						E &&
						(E[c] || a(E, c, h), E[d] || a(E, d, m), (l[m] = h), b)
					)
			...
			function (e, t, r) {
				...
				var n = r(1),
					...
					V = function (e, t) {
						b(e);
						for (
							var r, n = v((t = E(t))), o = 0, s = n.length;
							s > o;
				...
				i(i.S + i.F * !q, 'Symbol', {
					...
					L.prototype[T] ||
						r(10)(L.prototype, T, L.prototype.valueOf),
					d(L, 'Symbol'),
					d(Math, 'Math', !0),
					d(n.JSON, 'JSON', !0);
			},
