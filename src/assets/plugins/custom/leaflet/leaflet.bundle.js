...
!(function (t, e) {
			...
			_off: function (t, e, i) {
				...
				if (this._events && (n = this._events[t]))
					if (1 === arguments.length) {
						...
						(i === this && (i = void 0), 'function' != typeof e)
					)
						console.warn('wrong listener type: ' + typeof e);
					else {
	...
	(k.prototype = {
		...
		(R.prototype = {
			...
			contains: function (t) {
				t = ('number' == typeof t[0] || t instanceof F || 'lat' in t
					? N
					: D)(t);
				var e,
					i,
	...
	var Ze = I.extend({
		...
		Be = I.extend({
			...
			_limitCenter: function (t, e, i) {
				...
				return (o = this._getBoundsOffset(o, i, e))
					.round()
					.equals([0, 0])
					? t
	...
	var De,
		...
		Ne =
			...
			Fe.extend({
				...
				addTo: function (t) {
					return (
						Fe.prototype.addTo.call(this, t),
					...
					ne(this._element, 'leaflet-zoom-anim') ||
						(t.touches && 1 !== t.touches.length
							...
							: We._dragging ||
							  ...
							  ((We._dragging = this)._preventOutline &&
									me(this._element),
							  pe(),
							  Gt(),
							  this._moving ||
	...
	function He(t, e) {
		return e && t.length
			? (function (t, e) {
					var i = t.length,
						n = new (typeof Uint8Array != void 0 + ''
							? Uint8Array
							: Array)(i);
					(n[0] = n[i - 1] = 1),
	...
	var ei = e({}, j, {
		...
		li = hi.extend({
			...
			setStyle: function (t) {
				...
				return (
					hi.prototype.setStyle.call(this, t), this.setRadius(e), this
				);
			},
			_project: function () {
	...
	function _i(t, e) {
		...
		switch (r.type) {
			...
			case 'MultiLineString':
				return (
					(n = gi(a, 'LineString' === r.type ? 0 : 1, u)),
					new ci(n, e)
				);
			case 'Polygon':
			case 'MultiPolygon':
				return (
					(n = gi(a, 'Polygon' === r.type ? 1 : 2, u)), new di(n, e)
				);
		...
		getTileUrl: function (t) {
			var e = this._tileCoordsToNwSe(t),
				i =
					...
					i.max);
			e = (1.3 <= this._wmsVersion && this._crs === ei
				? [e.y, e.x, i.y, i.x]
				: [e.x, e.y, i.x, i.y]
			).join(',');
			return (
				...
				onAdd: function (t) {
					...
					for (var n = 0; n < this.options.providers.length; n++)
						this.options.providers[
							n
						]._contentsElement = e.DomUtil.create(
							'div',
							null,
							this._suggestions
						);
							...
							if (!t) {
								...
								for (var r = 0; r < s; r++) {
									...
									(a.layerId = l),
										...
										(a.displayFieldName = this._displayFields[
											l
										]),
										u &&
											o.push({
							...
							for (var o = 0; o < e.features.length; o++) {
								...
								if (
									...
									(r.layerId = a),
										...
										(r.displayFieldName = this._displayFields[
											a
										]);
									var l = {
										latlng: h.getCenter(),
