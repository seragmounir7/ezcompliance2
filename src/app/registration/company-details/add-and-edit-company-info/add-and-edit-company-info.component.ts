...
export class AddAndEditCompanyInfoComponent implements OnInit {
  ...
  drawComplete2() {
    ...
    this.formData.controls["plantSignature"].setValue(this.signaturePad2.toDataURL())
  ...
  onFormSubmit() {
    ...
    this.subscript.addsubscription(body).subscribe((data) => {
      console.log('data=>', data);
  ...
  patchData() {
    this.subscript.getsubscription(this.id).subscribe((data) => {
      ...
      data.data.insuranceRegister.insurance.length > 0 ? data.data.insuranceRegister.insurance.forEach(ele => {
        this.addInsurance2(ele);
      }):this.addInsuranceFiled2();
      
      data.data.plantRegister.plant.length > 0 ? data.data.plantRegister.plant.forEach(ele => {
      ...
      this.formData.patchValue({
        ...
        companyWeb: data.data.customerDetails.companyWeb,
        ...
        registrationNumber: data.data.plantRegister.plant.registrationNumber,
        registrationRenewalDate: data.data.plantRegister.plant.registrationRenewalDate,
        plantType: data.data.plantRegister.plant.plantType,
        purchaseDate: data.data.plantRegister.plant.purchaseDate,
        insurancePolicyNumber: data.data.plantRegister.plant.insurancePolicyNumber,
        ...
        documentNumber: data.data.insuranceRegister.insurance.documentNumber,
        documentType: data.data.insuranceRegister.insurance.documentType,
        documentName: data.data.insuranceRegister.insurance.documentName,
        ...
        reminderNotice: data.data.insuranceRegister.insurance.reminderNotice,
      ...
      check2().then((res) => {
        ...
        this.signaturePad2.fromDataURL(data.data.plantRegister.signature)
